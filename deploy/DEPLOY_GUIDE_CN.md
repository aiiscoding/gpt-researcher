...
> 本教程手把手教你把 GPT Researcher 部署到云端，让你随时随地通过浏览器使用。

## 选择部署方式

| 方式 | 难度 | 月费 | 适合谁 |
|------|------|------|--------|
| **Railway（推荐）** | 最简单，点几下就行 | $10-20 | 不想折腾的人 |
| 自建服务器 | 需要一点 Linux 基础 | $20-24 | 想完全掌控数据的人 |

**如果你是小白，强烈推荐 Railway 方案** → 请看 [Railway 部署指南](./RAILWAY_GUIDE_CN.md)
